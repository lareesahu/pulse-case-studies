(()=>{
  ...
  document.querySelectorAll('.studio-card').forEach(card=>{
    ...
    /* The DNA art cover was retired: its ring poster has a white background, which read
       as a broken white panel on the dark card. This card now uses the standard device
       frame with a clip of the case capture, like every other cover. */
